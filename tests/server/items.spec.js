...
*/
    ...
    describe('dbOptions Function', function() {
        it('DB created successfully', function() {
            ...
            assert( resMock.send.lastCall.calledWith( { msg: 'Successfully NOT created database and populated!' } ), 'Unexpected argument: ' + JSON.stringify(resMock.send.lastCall.args) );
        });
